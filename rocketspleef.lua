...
MainFrame.Size = isMobile and UDim2.new(0.82, 0, 0.5, 0) or UDim2.new(0, 434, 0, 378)
MainFrame.Position = isMobile and UDim2.new(0.09, 0, 0.25, 0) or UDim2.new(0.343, 0, 0.196, 0)
...
-- Labels - EXACT ORIGINAL POSITIONS FOR PC
